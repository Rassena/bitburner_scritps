...
You are given the following string which contains only digits between 0 and 9:
 ...
 You are also given a target number of 30. Return all possible ways you can 
 add the +(add), -(subtract), and *(multiply) operators to the string such that 
 it evaluates to the target number. (Normal order of operations applies.)
